...
/* PROTO */
lc_list_t
lc_list_create (lc_createfn_t create_fn, lc_destroyfn_t destroy_fn, lc_comparefn_t compare_fn)
{
    lc_list_t newlist;
...
/* PROTO */
void
lc_list_destroy (lc_list_t list)
{
    lc_node_t trav, tmp;
...
/* PROTO */
lc_node_t
lc_list_findnode (lc_list_t list, lc_item_t item)
{
    lc_node_t trav;
...
/* PROTO */
lc_item_t
lc_list_finditem (lc_list_t list, lc_item_t item)
{
    lc_node_t n;
...
/* PROTO */
void
lc_list_delete_bynode (lc_list_t list, lc_node_t node)
{
...
/* PROTO */
void
lc_list_delete_byitem (lc_list_t list, lc_item_t item)
{
...
/* PROTO */
lc_node_t
lc_list_insertfirst (lc_list_t list, lc_item_t item)
{
    lc_node_t newnode;
...
/* PROTO */
lc_node_t
lc_list_insertlast (lc_list_t list, lc_item_t item)
{
    lc_node_t newnode;
...
/* PROTO */
lc_node_t
lc_list_insert_ordered (lc_list_t list, lc_item_t newitem)
{
    lc_node_t trav;
...
/* PROTO */
void
lc_list_foreach (lc_list_t list, lc_foreachfn_t foreachfn)
{
    lc_node_t trav;
...
/* PROTO */
void
lc_list_foreach_v (lc_list_t list, lc_foreachfn_v_t foreachfn_v, ...)
{
    lc_node_t trav;
    va_list ap;
...
/* PROTO */
void
lc_list_foreach_rev (lc_list_t list, lc_foreachfn_t foreachfn)
{
    lc_node_t trav;
...
/* PROTO */
lc_size_t
lc_list_getsize (lc_list_t list)
{
    return list->size;
}
