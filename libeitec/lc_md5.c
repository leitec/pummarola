...
/* PROTO */
void
lc_md5_init (lc_md5state_t * state)
{
    state->h0 = H0_I;
    state->h1 = H1_I;
    state->h2 = H2_I;
...
/* PROTO */
void
lc_md5_append (lc_md5state_t * state, lc_md5byte_t * message, lc_size_t len)
{
...
/* PROTO */
void
lc_md5_compute (lc_md5state_t * state)
{
    int i;
...
/* PROTO */
void
lc_md5_finish (lc_md5state_t * state, lc_md5byte_t digest[16])
{
